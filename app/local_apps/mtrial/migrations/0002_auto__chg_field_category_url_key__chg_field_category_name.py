...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mtrial_category', 'url_key', self.gf('django.db.models.fields.SlugField')(max_length=32))

        # Changing field 'Category.name'
        db.alter_column('mtrial_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Category.url_key'
        db.alter_column('mtrial_category', 'url_key', self.gf('django.db.models.fields.SlugField')(max_length=8))

        # Changing field 'Category.name'
        db.alter_column('mtrial_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=8))
